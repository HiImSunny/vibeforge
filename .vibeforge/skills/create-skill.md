**Vibeforge Project Adaptation (added 2025-06-07)**

This skill is copied/adapted from the host ECC environment for use by AI agents in Vibeforge projects and during Vibeforge development.

See .vibeforge/skills/index.md for usage rules and Vibeforge-specific notes (especially for security-related risks in agent/MCP/PTY context).

Original source in ECC bundle.
